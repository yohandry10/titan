  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Teléfonos",
      details: ["051 959 466 202", "051 956 347 558"],
      color: "text-blue-500",
    },
    {
      icon: Mail,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <Card className="scroll-reveal hover-lift">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-foreground mb-6">Solicita tu Cotización</h3>
          ...
          {/* Contact Information */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 content-start self-start">
        ...
        <div className="mt-10 scroll-reveal">
          <Card className="hover-lift">
            <CardContent className="p-0">
              <div className="h-72 md:h-80 rounded-xl overflow-hidden">
                <iframe 
        ...
        <div className="mt-14 scroll-reveal">
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12 text-white text-center">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">¿Tienes un proyecto urgente?</h3>
